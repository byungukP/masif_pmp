...
for ppi_pair_id in ppi_pair_ids:
    ...
    for ix, pid in enumerate(pids):
        ...
        try:
            roc_auc = roc_auc_score(ground_truth, scores)    # originally, scores[0] was scores in TFv1
        ...
        mymesh.set_attribute("iface", scores)    # originally, scores[0] was scores in TFv1
