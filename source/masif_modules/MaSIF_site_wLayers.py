...
class MaSIF_site(L.LightningModule):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # self.val_auc = pl.metrics.AUC(reorder=True)
    ...
    def forward(self, input_dict):
        ...
        if self.n_conv_layers > 1:
            ...
            print("vert100 surface desc before gather: {}".format(global_desc[100,:]))
            ...
            print("vert100 surface desc after gather: {}".format(global_desc[100,0,:]))
